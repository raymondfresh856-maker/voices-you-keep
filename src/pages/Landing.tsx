...
import { Mic, Heart, Gift, ShieldCheck, Star } from 'lucide-react';
        ...
        <section id="pricing" className="pricing-section">
          ...
          <div className="pricing-grid">
            ...
            <div className="price-card glass-panel popular">
              ...
              <a href={STRIPE_PRO_LINK} target="_blank" rel="noopener noreferrer" className="btn btn-primary">Choose Pro</a>
            </div>

            <div className="price-card glass-panel">
              <Star size={20} color="var(--color-accent)" style={{ marginBottom: '0.5rem' }} />
              <h3>Pro Plus Lifetime</h3>
              <div className="price">$27.99<span> once</span></div>
              <ul>
                <li>Everything in Pro</li>
                <li><strong>Voice Vault:</strong> Save voicemails forever</li>
                <li><strong>Photo Animation</strong> to recorded voices</li>
                <li>Lifetime access — pay once</li>
                <li>Priority support</li>
              </ul>
              <a href={STRIPE_PRO_PLUS_LINK} target="_blank" rel="noopener noreferrer" className="btn btn-primary">Get Lifetime Access</a>
            </div>
